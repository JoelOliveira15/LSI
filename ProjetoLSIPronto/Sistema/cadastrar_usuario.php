 ...
 <!-- DESCRIÇÃO DO INTENS DA TABELA -->  
   <TABLE BORDER=0 align="center"  cellspacing= width="800">
     ...
     <TR>
       ...
       <TD bgcolor="#EBEBEB"><INPUT type=text name="nome" size="50" maxlength="40" required placeholder="Digite Seu Nome" autofocus pattern ="^[a-zA-ZéúíóáÉÚÍÓÁùìòàÙÌÒÀãÃêôâÊÔÂ][a-zA-ZéúíóáÉÚÍÓÁùìòàÙÌÒÀãÃêôâÊÔÂ ]*$" class="myinputstyle"></TD>
       </TR>
     
     <TR>
       <TD bgcolor="#CCCCCC" class="myinputstyle" size=20 >E-mail:</TD>
       <TD bgcolor="#EBEBEB" >
         <INPUT type=text name="email" size="50" maxlength="40" required placeholder="exemplo@exemplo.com" autofocus pattern ="^([0-9a-zA-Z]+)([.,_]([0-9a-zA-Z]+))*[@]([0-9a-zA-Z]+)([.]([0-9a-zA-Z]+))*[.]([a-zA-Z]){2}([a-zA-Z])*$"class="myinputstyle"class="myinputstyle"></TD>
       </TR>
     ...
     <TR>
       ...
       <TR>
         ...
         <TD bgcolor="#EBEBEB" >
           <INPUT type=text name="login" size="20" maxlength="20"required placeholder="Login"  autofocus pattern ="^[a-zA-ZéúíóáÉÚÍÓÁùìòàÙÌÒÀãÃêôâÊÔÂ]*$"  class="myinputstyle"></TD>
         </TR>
     ...
     <TR>
       ...
       <TR>
         ...
         <TD bgcolor="#EBEBEB" >
           <INPUT type = "password"  name="senha1" size="20" maxlength="8"required placeholder="Apenas letras" ></TD>
         </TR>
     <TR>
     ...
     <TR>
       ...
       <TR>
         ...
         <TD bgcolor="#EBEBEB" >
           <INPUT type=text name="cpf" size="20"maxlength="20" required placeholder="ex 000.000.000-00" autofocus pattern ="^([0-9]{3}[/.]){2}[0-9]{3}-[0-9]{2}$" class="myinputstyle"> </TD>
         </TR>
...
if($senha1==$senha2){# verifica senha
	if($nome!=" "){
		...
		if($er_login==" " && $er_cpf==" " && $er_email==" "){# a linha abaixo inseri os dados 
			mysql_query("INSERT INTO bdusuarios (nome,email,login,senha,cpf,tipo) VALUES ('$nome','$email','$login','$senha1','$cpf', '$tipo')");
			mysql_close($con);
				echo"<table bgcolor=#00FF7F width=300 border=0 align=center>
					...
					?><script type="text/javascript">
						window.setTimeout("location.href='login.php';", 800);
					</script>
					<?php
