...
<body>
        ...
        < <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Listar Todos os Transtornos</h2>                      
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
    ...
    $cont1=0;
    $cont2=0;
    $rs = mysql_query("SELECT * FROM transtorno");  // Executa a query (o recordset $rs contém o resultado da query)
...
echo'<table width="100%" border="0" align="" cellpadding="0" cellspacing="0">
    ...
    <td bgcolor="#202020" class="fonte"><font color="#FF0000">Mensagem</font></td>
    <td colspan="2"  bgcolor="#202020" class="fonte" width=""><font color="#FF0000"></font></td>
    <td colspan="2"  bgcolor="#202020" class="fonte" width=""><font color="#FF0000"></font></td>
    </tr>';
$contt=0;
...
while($array = mysql_fetch_array($rs)){ // Cada linha vai para um array  usando mysql_fetch_array
    ...
    if($logado==$nome){
        ...
        echo '<td><a href="edita_geral_transt.php?codigo='.$id.'">editar</a></td>'; 
        echo '<td><a href="excluir_trans.php?codigo='.$id.'">excluir</a></td>'; 
