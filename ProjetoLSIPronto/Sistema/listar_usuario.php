...
echo'<table width="100%" border="0" align="" cellpadding="0" cellspacing="0">
    ...
    <td bgcolor="#202020" class="fonte" width=""><font color="#FF0000">CPF</font></td>
    <td colspan="3"  bgcolor="#202020" class="fonte" width=""><font color="#FF0000">Nivel</font></td>
    <td colspan="2"  bgcolor="#202020" class="fonte" width=""><font color="#FF0000">Opção</font></td>
    </tr>';
$contt=0;
...
while($array = mysql_fetch_array($rs)){ // Cada linha vai para um array  usando mysql_fetch_array
    ...
    if($logado==$usuario){
        ...
        echo '<td><a href="editar_geral.php?codigo='.$id.'">editar</a></td>'; 
        echo '<td><a href="excluir_user.php?codigo='.$id.'">excluir</a></td>'; 
