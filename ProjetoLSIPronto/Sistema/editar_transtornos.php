...
<body>
    ...
    <TABLE BORDER=0 align="center"  cellspacing= width="800">
     ...
     <TR>
       <TD>Nome:</TD>
       <TD bgcolor="#EBEBEB"><INPUT type=text name="nome" size="50" maxlength="40" required placeholder="Nome Do Transorno" class="myinputstyle"></TD>
    </TR>
     
     <TR>
       <TD>Descrição:</TD>
       <TD bgcolor="#EBEBEB"><INPUT type=text name="mensagem" size="50" maxlength="40" required placeholder="Descrição do Transtorno" class="myinputstyle"></TD>
      </TR>   
