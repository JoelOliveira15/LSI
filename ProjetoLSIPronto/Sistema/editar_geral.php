...
<body> 
        ...
        <FORM name=clinicmed method="POST"  alig="center" action="edita_user.php" class="myinputstyle">
...
$codigo = $_GET["codigo"];
$sql    = "SELECT * FROM bdusuarios WHERE codigo = '$codigo'";
...
<input type="number" hidden="true" name="codigo" value="<?php echo $codigo;?>">
     ...
     <TR>
       ...
       <TR>
        ...
        <TD bgcolor="#CCCCCC" class="myinputstyle" size=20  >Nível de Usuário:</TD>
         <TD bgcolor="#EBEBEB" >
         <select name = "tipo">
