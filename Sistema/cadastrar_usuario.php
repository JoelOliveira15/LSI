 ...
 <!-- DESCRIÇÃO DO INTENS DA TABELA -->  
   <TABLE BORDER=0 align="center"  cellspacing= width="800">
     ...
     <TR>
       ...
       <TD bgcolor="#EBEBEB" >
         <INPUT type=text name="email" size="50" maxlength="40" required placeholder="Email" autofocus pattern ="^([0-9a-zA-Z]+)([.,_]([0-9a-zA-Z]+))*[@]([0-9a-zA-Z]+)([.]([0-9a-zA-Z]+))*[.]([a-zA-Z]){2}([a-zA-Z])*$"class="myinputstyle"class="myinputstyle"></TD>
       </TR>
     ...
     <TR>
       ...
       <TR>
         ...
         <TD bgcolor="#EBEBEB" >
           <INPUT type = "password"  name="senha1" size="20" maxlength="8"required placeholder="Senha" ></TD>
         </TR>
     <TR>
     ...
     <TR>
       ...
       <TR>
         ...
         <TD bgcolor="#EBEBEB" >
           <INPUT type=text name="cpf" size="20"maxlength="20" required placeholder="CPF" autofocus pattern ="^([0-9]{3}[/.]){2}[0-9]{3}-[0-9]{2}$" class="myinputstyle"></TD>
         </TR>
